...
<tr><td colspan="2" class="toptd">Perditeso Paket</td></tr>
<tr><td class="lefttxt">Zgjidh Paket</td><td><select name="s1" required/><option value="">Zgjidh</option>
...
<tr><td class="lefttxt">Emri i Paketes</td><td><input type="text"  value="<?php if(isset($_POST["show"])){ echo $Packname ;} ?> " name="t1" required pattern="[a-zA-z _]{1,50}" title"Ju lutem fusni 1-50 karaktere per emrin e paketes"/></td></tr>
...
<tr><td class="lefttxt">Zgjidh Kategori</td><td><select name="t3" required/><option value="">Zgjidh</option>
...
<tr><td class="lefttxt">Cmimi i Paketese</td><td><input type="text" name="t8" value="<?php if(isset($_POST["show"])){ echo $Packprice ;} ?> " /></td></tr>

<tr><td class="lefttxt">Foto e vjeter</td><td><img src="packimages/<?php echo @$Pic1; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Foto e Vjeter</td><td><img src="packimages/<?php echo @$Pic2; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Foto e Vjeter</td><td><img src="packimages/<?php echo @$Pic3; ?>" width="150px" height="50px" />
...
<tr><td class="lefttxt">Detajet</td><td><textarea name="t7" /><?php if(isset($_POST["show"])){ echo $Detail ;} ?></textarea></td></tr>
