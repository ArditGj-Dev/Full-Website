...
<tr><td colspan="2" class="toptd">Shto Subkategori</td></tr>
<tr><td class="lefttxt">Emri i Subkategorise</td><td><input type="text" name="t1" required pattern="[a-zA-z _]{2,50}" title"Ju lutem fusni vetem karaktere dhe numra midis 2-50"/></td></tr>
...
if(isset($_POST["sbmt"]))
{
	...
	if(file_exists($target_file)){
		echo "Me vjen keq, dosja ekziston nje here.";
		$uploadok=0;
	}
	...
	echo "<script>alert('Te Dhenat u Ruajten');</script>";
			...
			echo "Me vjen keq, ka nje error gjate ngarkimit te dosjeve.";
		}}
}
?>
