...
<tr><td colspan="2" class="toptd">Shto Kategori</td></tr>
<tr><td class="lefttxt">Emri i Kategorise</td><td><input type="text" name="t1" required pattern="[a-zA-z _]{3,20}" title"Ju lutem fusni vetem karaktere dhe numra midis 3-10" /></td></tr>
