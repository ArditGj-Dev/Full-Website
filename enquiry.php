...
<tr><td class="lefttxt">Emri:</td><td><input type="text" name="t1" required pattern="[a-zA-z1 _]{3,50}" title"Ju lutemi shkruani vetëm personazhet dhe numrat midis 1 deri 50 për emrin"/></td></tr><br/>
...
<tr><td class="lefttxt">Nr. Cel.</td><td><input type="text" name="t2" required pattern="[0-9]{10,12}" title"Ju lutemi shkruani vetëm numrat midis 10 deri 12 për celularin Nr"/></td></tr><br/>
<tr><td class="lefttxt">Email:</td><td><input type="email" name="t3" required /></td><td><br/>
<tr><td class="lefttxt">Nr.i Diteve:</td><td><input type="number" name="t4" required pattern="[1 _]{1,20}" title"Ju lutemi Vendosni vetëm numrat midis 1 deri 20 për Ditët Nr"/></td><td><br/>
<tr><td class="lefttxt">Nr.i Femijeve:</td><td><input type="number" name="t5" required pattern="[1 _]{1,10}" title"Ju lutemi shkruani vetëm numrat midis 1 deri 10 për fëmijë"/></td><td><br/>
<tr><td class="lefttxt">Nr.i te Rriturve:</td><td><input type="number" name="t6" required pattern="[1 _]{1,20}" title"Ju lutemi shkruani vetëm numrat midis 1 deri 20 për nr. e të rriturve"/></td><td><br/>
